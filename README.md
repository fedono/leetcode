...
> 通常都是看别人的面经，然后看到有 LeetCode 题，然后来刷，比如有些 DP 的题，看完当前的题的时候，可以把当前 DP 类的简单的都刷下，毕竟简单的一般都不用怎么思考，就是学习一下思路
>
...
[剑指 Offer61-扑克牌中的顺子](./solutions/剑指Offer61-扑克牌中的顺子.md)\
...
[146-LRU 缓存机制](./solutions/146-LRU缓存机制.md)\
...
[63-不同路径 2](./solutions/63-不同路径2.md)\
...
[1-两数之和](./solutions/1-两数之和.md)\
[19-删除链表的倒数第 N 个节点](./solutions/19-删除链表的倒数第N个节点.md)\
[42-接雨水](./solutions/42-接雨水.md)\
[80-删除排序链表中的重复元素](./solutions/80-删除排序链表中的重复元素.md)\
[80-删除有序数组中的重复项-ii](./solutions/80-删除有序数组中的重复项-ii.md)\
[121-买卖股票的最佳时机](./solutions/121-买卖股票的最佳时机.md)\
...
[1011-在 D 天内送达包裹的能力](./solutions/1011-在D天内送达包裹的能力.md)
